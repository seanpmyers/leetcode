pub mod character_count {
    ...
    impl Solution {
        pub fn check_inclusion(s1: String, s2: String) -> bool {
            ...
            let mut s1_count: [u16; 26usize] = [0u16; 26usize];
            let mut count: [u16; 26usize] = [0u16; 26usize];

            let mut l: usize = 0;
            let mut r: usize = s1.len();

            for i in 0..s1.len() {
                let x: usize = (s1[i] - b'a') as usize;
                let y: usize = (s2[i] - b'a') as usize;
                s1_count[x] += 1;
                count[y] += 1;
            }
            ...
            while r < s2.len() {
                ...
                let x: usize = (s2[l] - b'a') as usize;
                let y: usize = (s2[r] - b'a') as usize;
                count[x] -= 1;
                count[y] += 1;
                l += 1;
                r += 1;
